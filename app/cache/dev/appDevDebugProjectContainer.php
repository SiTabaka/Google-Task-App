...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'happyr.google.api.analytics' => 'getHappyr_Google_Api_AnalyticsService',
            'happyr.google.api.client' => 'getHappyr_Google_Api_ClientService',
            'happyr.google.api.youtube' => 'getHappyr_Google_Api_YoutubeService',
            'http_kernel' => 'getHttpKernelService',
            'iut_task.google' => 'getIutTask_GoogleService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sf2', 'user' => 'sf2', 'password' => 'passw0rd', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\iut\\TaskBundle\\Entity'))), 'iut\\TaskBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('iutTaskBundle' => 'iut\\TaskBundle\\Entity'));
    ...
    /**
     * Gets the 'happyr.google.api.analytics' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HappyR\Google\ApiBundle\Services\AnalyticsService A HappyR\Google\ApiBundle\Services\AnalyticsService instance.
     */
    protected function getHappyr_Google_Api_AnalyticsService()
    {
        return $this->services['happyr.google.api.analytics'] = new \HappyR\Google\ApiBundle\Services\AnalyticsService($this->get('happyr.google.api.client'));
    }

    /**
     * Gets the 'happyr.google.api.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HappyR\Google\ApiBundle\Services\GoogleClient A HappyR\Google\ApiBundle\Services\GoogleClient instance.
     */
    protected function getHappyr_Google_Api_ClientService()
    {
        return $this->services['happyr.google.api.client'] = new \HappyR\Google\ApiBundle\Services\GoogleClient(array('application_name' => 'sf2', 'oauth2_client_id' => '716745761586-93pv0rgg2sqddj41v14em8vkjlu4fvba.apps.googleusercontent.com', 'oauth2_client_secret' => 'vALWu2DFP0CV-OSBOXMwENdv', 'oauth2_redirect_uri' => 'http://localhost:8081/app_dev.php/oauth2callback', 'developer_key' => 'AlzaSyA8-dq0QuoYRcT6_tNKXk-bZGytXpV3-_c', 'site_name' => 'sf2'));
    }

    /**
     * Gets the 'happyr.google.api.youtube' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HappyR\Google\ApiBundle\Services\YoutubeService A HappyR\Google\ApiBundle\Services\YoutubeService instance.
     */
    protected function getHappyr_Google_Api_YoutubeService()
    {
        return $this->services['happyr.google.api.youtube'] = new \HappyR\Google\ApiBundle\Services\YoutubeService($this->get('happyr.google.api.client'));
    }
    ...
    /**
     * Gets the 'iut_task.google' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \iut\TaskBundle\Google A iut\TaskBundle\Google instance.
     */
    protected function getIutTask_GoogleService()
    {
        return $this->services['iut_task.google'] = new \iut\TaskBundle\Google();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\iut\\DumbBundle/Resources/views'), 'iutDumb');
        $instance->addPath(($this->targetDirs[3].'\\src\\iut\\TaskBundle/Resources/views'), 'iutTask');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55df022902979')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'iutDumbBundle' => 'iut\\DumbBundle\\iutDumbBundle',
                'NelmioSecurityBundle' => 'Nelmio\\SecurityBundle\\NelmioSecurityBundle',
                'iutTaskBundle' => 'iut\\TaskBundle\\iutTaskBundle',
            ...
            'happy_r_google_api' => array(
                'application_name' => 'sf2',
                'oauth2_client_id' => '716745761586-93pv0rgg2sqddj41v14em8vkjlu4fvba.apps.googleusercontent.com',
                'oauth2_client_secret' => 'vALWu2DFP0CV-OSBOXMwENdv',
                'oauth2_redirect_uri' => 'http://localhost:8081/app_dev.php/oauth2callback',
                'developer_key' => 'AlzaSyA8-dq0QuoYRcT6_tNKXk-bZGytXpV3-_c',
                'site_name' => 'sf2',
            ),
